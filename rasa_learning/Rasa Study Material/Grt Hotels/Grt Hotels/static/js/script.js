...
function action_trigger() {
    ...
    var bleepat = new Audio();
    bleepat.src = "done-for-you.mp3";
    $.ajax({
        ...
        error: function(xhr, textStatus, errorThrown) {
            ...
            setBotResponse("Hello from grt hotel");
        ...
        if (response.length < 1) {
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("custom")) {
                    ...
                    if (response[i].custom.payload == "dynamiclink") {
                        renderDynamiclink()
                        return;
                    }
...
function renderDynamiclink() {
    cools = "https://grthotels.com/"
    var select = '<div class="dropDownMsg">' +
                 '<p>Please visit our website to book your stay</p>'+
                '<a href="' + cools + '" target="_blank"><span>https://grthotels.com/</span></a>'
                 '</div>'
    $(".chats").append(select);
    scrollToBottomOfResults();
}